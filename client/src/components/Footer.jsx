          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-serif text-xl font-bold tracking-tight text-slate-800">
                Rashi <span className="text-dreamy-lavender-600 italic font-semibold">Dreamy</span> Gifts
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2 rounded-full border border-dreamy-pink-200 text-slate-400 hover:text-dreamy-lavender-600 hover:border-dreamy-lavender-300 transition-colors"
              >
